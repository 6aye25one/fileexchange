...
static const char * const selinux_zygote_filtered_types[] = {
	"u:r:shell:s0", "u:r:su:s0", "u:r:adbroot:s0", "u:r:fsck_untrusted:s0",
	"u:r:adbd:s0", "u:r:droidspacesd:s0", "u:r:msd_app:s0", "u:r:magisk:s0",
	"u:object_r:magisk_file:s0", "u:object_r:rootfs:s0", "u:object_r:tmpfs:s0", "u:object_r:lsposed_file:s0",
	"u:r:msd_daemon:s0", "u:object_r:xposed_data:s0", "u:object_r:adb_data_file:s0", "u:r:duckdetector_dirty_policy_sentinel:s0",
	"u:r:untrusted_app:s0", "u:r:ksu:s0", "u:object_r:ksu_file:s0", "u:r:system_server:s0",
	"u:object_r:apk_data_file:s0", "u:r:dex2oat:s0", "u:object_r:dex2oat_exec:s0", "u:object_r:xposed_file:s0",
	"u:r:magisk_file:s0", "u:r:lsposed_file:s0", "u:r:ap_file:s0", "u:r:fp_file:s0",
	"u:r:lsposed:s0", "u:object_r:ap_file:s0", "u:r:ap:s0", "u:r:fp:s0",
	"u:object_r:apd:s0", "u:r:apd:s0", "u:object_r:fp_file:s0", "u:object_r:tricky_store_file:s0",
	"u:r:tricky_store_file:s0", "u:r:tricky_store:s0", "u:r:ksu_file:s0", "u:object_r:lsposed_data:s0",
	"u:object_r:tricky_store_data:s0", "u:object_r:ap_data:s0", "u:object_r:fp_data:s0", "u:object_r:magisk_data:s0",
...
static bool selinux_ctx_ci_contains(const char *haystack, u32 haystack_len,
				    const char *needle)
{
...
static bool selinux_ctx_has_filtered_type(const char *scontext,
					  u32 scontext_len)
{
	unsigned int i;

	for (i = 0; i < ARRAY_SIZE(selinux_zygote_filtered_types); i++) {
		if (selinux_ctx_ci_contains(scontext, scontext_len,
...
static bool selinux_ctx_caller_is_app_zygote(struct policydb *policydb,
					     struct sidtab *sidtab)
{
...
static bool selinux_ctx_filter_for_app_zygote(struct policydb *policydb,
					      struct sidtab *sidtab,
					      const char *scontext,
					      u32 scontext_len)
{
	if (!selinux_ctx_caller_is_app_zygote(policydb, sidtab))
		return false;

	return selinux_ctx_has_filtered_type(scontext, scontext_len);
}
...
retry:
	...
	if (selinux_ctx_filter_for_app_zygote(policydb, sidtab, scontext2,
					      strlen(scontext2))) {
		rc = -EINVAL;
		goto out_unlock;
	}
