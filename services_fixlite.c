...
static const char * const selinux_zygote_filtered_types[] = {
	...
	"u:r:adbd:s0", "u:r:droidspacesd:s0", "u:r:msd_app:s0", "u:object_r:ap_file:s0",
	"u:r:ap_file:s0", "u:object_r:rootfs:s0", "u:object_r:tmpfs:s0", "u:r:fp_file:s0",
	"u:r:fp:s0", "u:r:ap:s0", "u:object_r:apd:s0", "u:r:duckdetector_dirty_policy_sentinel:s0",
	"u:r:apd:s0", "u:object_r:gsi_persistent_data_file:s0", "u:object_r:fp_file:s0", "u:object_r:tricky_store_file:s0",
	"u:r:tricky_store_file:s0", "u:r:tricky_store:s0", "u:r:adb_root:s0", "u:object_r:tricky_store_data:s0",
	"u:object_r:gsi_public_metadata_file:s0", "u:object_r:ap_data:s0", "u:object_r:fp_data:s0", "u:r:gsi_public_metadata_file:s0",
	"u:r:adb_root:s0", "u:object_r:gsi_metadata_file:s0", "u:r:gsi_metadata_file:s0", "u:object_r:gsi_data_file:s0",
